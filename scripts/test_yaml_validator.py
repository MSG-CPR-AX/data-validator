...
이 모듈은 yaml_validator.py의 기능을 테스트합니다.
"""
...
import os
import yaml
from yaml_validator import validate_bookmarks, load_yaml_file
...
class TestYamlValidator(unittest.TestCase):
    ...
    def test_valid_bookmark(self):
        ...
        has_errors = validate_bookmarks(valid_bookmark)
    ...
    def test_missing_required_field(self):
        ...
        has_errors = validate_bookmarks(invalid_bookmark)
